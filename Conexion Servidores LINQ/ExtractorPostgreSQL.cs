...
namespace Conexion_Servidores_LINQ  
{
    ...
    {
        private const string NombreBaseDatos = "ConexionPostgreSQL";
        ...
        public async Task<(bool Success, DataTable Data, string Message)> ObtenerProductosAsync()
        {
            try
            {
                ...
                return ValidarYRetornarResultado(dataTable, "No hay productos en la base de datos", 
        ...
        public async Task<(bool Success, Dictionary<string, object> Stats, string Message)> ObtenerEstadisticasAsync()
        {
            ...
            try
            {
                ...
                if (await reader.ReadAsync())
                {
                    ...
                    {
                        { "Total", reader["Total"] },
                        { "CategoriasUnicas", reader["CategoriasUnicas"] },
        ...
        /// <summary>
        /// Muestra una página de la tabla usando foreach.
        /// </summary>
